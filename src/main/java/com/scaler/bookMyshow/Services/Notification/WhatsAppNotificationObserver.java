...
public class WhatsAppNotificationObserver implements NotificationObserver {
    ...
    @Autowired
    public WhatsAppNotificationObserver(NotificationMessageFactory notificationMessageFactory) {
    ...
    public void notify(Booking  booking, BookingEventType eventType) {
        ...
        System.out.println("WhatsApp notification sent to "+ booking.getUser().getPhone()+" :"+ message);
    }
}
